...
const About = () => {
  return (
    <section
      className="flex-row items-center p-14  overflow-x-hidden"
      id="about"
    >
      ...
      <div className="flex flex-col md:flex-row">
        ...
        />
        <div
          className="flex flex-col justify-center items-center pl-6 font-medium"
          data-aos="fade-left"
          data-aos-duration="1000"
        >
          <p>
            Hi, I'm Srijan Kumar Gupta, an undergraduate student, currently
            pursuing Btech. course in Computer Science and Engineering at
            Calcutta Institute of Engineering and Management. <br />
            <br />
            Taking web development as a profession not only fulfils my pocket
            but also my heart because it has been my passion since my early
            teenage. I believe that people should do things in which they are
            good at or in which their heart lays.
            <br />
            <br />
